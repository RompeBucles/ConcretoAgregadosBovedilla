...
namespace SistemaRegistro
{
    public partial class RegistroEntradasSalidas : Form
    {
        ...
        public RegistroEntradasSalidas()
        {
            ...
            ListaUnidad.Add("Área (ha)");
            ListaUnidad.Add("Área*Tiempo (m²*año)");
            ListaUnidad.Add("Capacidad de peso (kg*s)");
            ListaUnidad.Add("Capacidad de volumen (l*hora)");
            ListaUnidad.Add("Capacidad de conversión de energía (MW)");
            ListaUnidad.Add("Densidad (kg*l)");
            ListaUnidad.Add("Masa (kg)");
            ListaUnidad.Add("Capacidad de peso (kg*s)");
            ListaUnidad.Add("Longitud (m)");
            ListaUnidad.Add("Servicio de transporte (ton*km)");
            ListaUnidad.Add("Servicio de transporte (persona*km)");
            ListaUnidad.Add("Metro*año (m*año)");
            ListaUnidad.Add("Unidad (item)");
            ListaUnidad.Add("Electricidad (kWh)");
            ListaUnidad.Add("Energía (MJ)");
            ListaUnidad.Add("Tiempo de uso del equipo (hora)");
            ListaUnidad.Add("Productos líquidos (l)");
